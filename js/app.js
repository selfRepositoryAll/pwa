(function () {
  ...
  fetch('https://easy-mock.com/mock/59a8fd8e83eb501241b25220/example/user').then(res => res.json())
    .then(({data}) => {
      console.log('>>>>');
      console.log('res', data['手机'][0])
      document.getElementById('test').innerHTML=data['手机'][0]
    })
